...
description: Authors faithful and deep notes, integrates explanations, and resolves bounded semantic conflicts. Execution profile quality_high; invoke only when the manager assigns a bounded packet and output path.
